...
abstract class ReportQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, installation_id, report_id, app_version_code, app_version_name, package_name, file_path, phone_model, brand, product, android_version, build, total_mem_size, available_mem_size, build_config, custom_data, is_silent, stack_trace, initial_configuration, crash_configuration, display, user_comment, user_email, user_app_start_date, user_crash_date, dumpsys_meminfo, logcat, device_features, environment, shared_preferences, date_received, application_log, device_id, dropbox, eventslog, media_codec_list, radiolog, settings_global, settings_secure, settings_system, stack_trace_hash, thread_details FROM report WHERE id = :p0';
        try {
