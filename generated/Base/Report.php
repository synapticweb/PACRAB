...
abstract class Report implements ActiveRecordInterface
{
     ...
     * @var        string
     */
    protected $settings_global;

    /**
     * The value for the settings_secure field.
     *
     * @var        string
     */
    protected $settings_secure;

    /**
     * The value for the settings_system field.
     *
     * @var        string
     */
     ...
     * @var        string
     */
    protected $stack_trace_hash;

    /**
     * The value for the thread_details field.
     *
     * @var        string
     */
    ...
    /**
     * Get the [eventslog] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [settings_global] column value.
     *
     * @return string
     */
    public function getSettingsGlobal()
    {
        return $this->settings_global;
    }

    /**
     * Get the [settings_secure] column value.
     *
     * @return string
     */
    public function getSettingsSecure()
    {
        return $this->settings_secure;
    }

    /**
     * Get the [settings_system] column value.
     *
     * @return string
     */
    public function getSettingsSystem()
    {
        return $this->settings_system;
    }
    ...
    {
        return $this->stack_trace_hash;
    }

    /**
     * Get the [thread_details] column value.
     *
     * @return string
     */
    ...
    public function setRadiolog($v)
    {
        ...
        if ($this->radiolog !== $v) {
            $this->radiolog = $v;
            $this->modifiedColumns[ReportTableMap::COL_RADIOLOG] = true;
        }
     ...
     * @return $this|\Report The current object (for fluent API support)
     */
    public function setSettingsGlobal($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->settings_global !== $v) {
            $this->settings_global = $v;
            $this->modifiedColumns[ReportTableMap::COL_SETTINGS_GLOBAL] = true;
        }
    ...
    /**
     * Set the value of [settings_secure] column.
     *
     * @param string $v new value
     * @return $this|\Report The current object (for fluent API support)
     */
    public function setSettingsSecure($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->settings_secure !== $v) {
            $this->settings_secure = $v;
            $this->modifiedColumns[ReportTableMap::COL_SETTINGS_SECURE] = true;
        }
    ...
    /**
     * Set the value of [settings_system] column.
     *
     * @param string $v new value
     * @return $this|\Report The current object (for fluent API support)
     */
    public function setSettingsSystem($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->settings_system !== $v) {
            $this->settings_system = $v;
            $this->modifiedColumns[ReportTableMap::COL_SETTINGS_SYSTEM] = true;
        }
     ...
     * @return $this|\Report The current object (for fluent API support)
     */
    public function setStackTraceHash($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->stack_trace_hash !== $v) {
            $this->stack_trace_hash = $v;
            $this->modifiedColumns[ReportTableMap::COL_STACK_TRACE_HASH] = true;
        }
    ...
    /**
     * Set the value of [thread_details] column.
     *
     * @param string $v new value
     * @return $this|\Report The current object (for fluent API support)
     */
    public function setThreadDetails($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->thread_details !== $v) {
            $this->thread_details = $v;
            $this->modifiedColumns[ReportTableMap::COL_THREAD_DETAILS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 42; // 42 = ReportTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ReportTableMap::COL_SETTINGS_SECURE)) {
            $modifiedColumns[':p' . $index++]  = 'settings_secure';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'settings_secure':
                        $stmt->bindValue($identifier, $this->settings_secure, PDO::PARAM_STR);
                        break;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ReportTableMap::COL_SETTINGS_SECURE)) {
            $criteria->add(ReportTableMap::COL_SETTINGS_SECURE, $this->settings_secure);
        }
        if ($this->isColumnModified(ReportTableMap::COL_SETTINGS_SYSTEM)) {
